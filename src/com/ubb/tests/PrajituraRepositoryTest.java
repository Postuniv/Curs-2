...
class PrajituraRepositoryTest {

    PrajituraRepository getTestRepository() {
        PrajituraRepository repository = new PrajituraRepository();
    ...
    @Test
    void create() {
        PrajituraRepository repository = getTestRepository();
